...
let validator = [
  body("firstName")
    ...
    .withMessage(
      "Please fill your first name and should be at least 5 characters and not more than 50 characters"
    )
    .trim(),
  body("lastName")
    .isLength({ min: 5, max: 50 })
    .withMessage(
      "Please fill your last name and should be at least 5 characters and not more than 50 characters"
    )
    .trim(),
  body("email")
    .isEmail()
